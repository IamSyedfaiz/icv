                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3" method="POST" action="{{ route('create.user') }}">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="cat" name="uname" required>
                                </div>
                                <!-- Use auto complete js https://jqueryui.com/autocomplete/ -->
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="number" class="form-control" id="refno" name="uphone" required>
                                    @error('uphone')
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="password" class="form-control" id="refno" name="upassword" required>
                                    @error('upassword')
                                        <p class="small text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
